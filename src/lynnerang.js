const reactTerms = [
  {
    ...
    "example": "Babel is most commonly used for React and transforms ES6 syntax into syntax that older browsers can interpret."
  }, {
    "id": 3,
    "term": "Bundlers",
    ...
    "example": "Those commonly used in React applications include Webpack and Browserify."
  }, {
    "id": 4,
    "term": "Package Managers",
    "definition": "Tools that allow you to manage dependencies in your project.",
    "example": "npm and Yarn are two package managers commonly used in React applications."
  }, {
    "id": 5,
    "term": "CDN",
    ...
    "example": "Akamai, Amazon CloudFront, CacheFly."
  }, {
    "id": 6,
    "term": "JSX",
    ...
    "id": 11,
    "term": "state",
    "definition": "A kind of data needed for a component when it will change over time. For example, a Checkbox component might need something like isChecked.  It's different from props in that it's managed by the component itself.",
    "example": "./images/example{exampleId}.png"
  }, {
    "id": 12,
